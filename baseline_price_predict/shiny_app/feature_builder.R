...
load_training_sample <- function() {
  ...
  possible_paths <- c(
    ...
    file.path(getwd(), "baseprice_model", "nn_price_training_v4.csv"),
    file.path(dirname(dirname(getwd())), "baseline_price_predict", "baseprice_model", "nn_price_training_v4.csv"),
    file.path(dirname(getwd()), "baseprice_model", "nn_price_training_v4.csv")
  )
