...
Ensure these model files exist in `baseprice_model/` directory:
...
1. Check you're in the correct directory: `baseline_price_predict`
2. Make sure all R packages are installed
3. Try: `source("shiny_app/run_app.R")`

### Model loading fails

1. Check model files exist in `baseprice_model/` directory
